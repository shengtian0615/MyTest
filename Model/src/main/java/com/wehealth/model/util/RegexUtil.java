...
public class RegexUtil {
	...
	static private String phoneReg = "1[3456789]\\d{9}";
    static private String shuzi = "^[0-9]*";
     ...
     */
    public static boolean phoneFromContacts(String phoneStr) {
        if (phoneStr.startsWith("+")){
            phoneStr = phoneStr.substring(3, phoneStr.length());
        }
    ...
    public static boolean checkClinic(String clinicName){
        Pattern pattern = Pattern.compile(shuzi);
        Matcher matcher = pattern.matcher(clinicName);
        return matcher.matches();
    }

    public static boolean isLetter(String clinicName){
        boolean isLetter = false;
        for (int i = 0; i < clinicName.length(); i++) {
            int codePoint = clinicName.charAt(i);
