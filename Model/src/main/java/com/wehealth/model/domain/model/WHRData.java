...
public class WHRData implements TimeAuditable, Serializable {
	private Long id;
	private Date createTime;
	private Date updateTime;
	//病人身份证号
	private String patientId;
	private float waistLength;  //cm
	private float hipLength;  //cm
	private String note;
	...
	public void setHipLength(float hipLength) {
